...
public class DisplayJPanel extends javax.swing.JPanel {
	 ...
	 */
	// Person person;
	public DisplayJPanel(ArrayList<Person> lista, int id) {
		initComponents();
		// this.person=person;
		this.lista = lista;
		this.seleccionado = id;
		if (!lista.isEmpty()) {
			displayPerson(lista.get(seleccionado));
		}
	}
	...
	public void displayPerson(Person person) {
	    ...
	    fechaTextField.setText(person.getFechaIncorporacion());
	    depTextField.setText(String.valueOf(person.getDepartment()));
	    jLabel1.setText("Display Profile - ID: " + person.getId());

		String imageTxt = person.getImagetxt();
		// imagePatTxt.setText(imageTxt);
		imageLabel.setIcon(null);
		if (imageTxt != null && new File(imageTxt).exists()) {
		try {
	        ...
	        imageLabel.setText("Foto no disponible");
		}
	}
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(layout.createSequentialGroup().addGap(64)
						.addGroup(layout.createParallelGroup(Alignment.LEADING)
								.addGroup(layout.createSequentialGroup()
										...
										.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
												.addComponent(fechaTextField).addComponent(bankTextField)
												.addComponent(ssnTextField, GroupLayout.PREFERRED_SIZE, 244,
						...
						.addGap(260))
				.addGroup(layout.createSequentialGroup().addContainerGap(218, Short.MAX_VALUE)
						.addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 334, GroupLayout.PREFERRED_SIZE)
						.addGap(309)));
		layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(74).addComponent(jLabel1).addGap(68)
						.addGroup(layout.createParallelGroup(Alignment.TRAILING)
								.addGroup(layout.createSequentialGroup()
										.addGroup(layout.createParallelGroup(Alignment.TRAILING)
												.addGroup(layout.createSequentialGroup().addComponent(jLabel2)
												...
												.addGroup(layout.createSequentialGroup()
														...
														.addComponent(geoTextField, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(layout.createParallelGroup(Alignment.LEADING).addComponent(jLabel4)
												.addComponent(dobTextField, Alignment.TRAILING,
										...
										.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
												.addGroup(layout.createSequentialGroup()
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(depTextField, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(emailTextField, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
												.addGroup(layout
														.createSequentialGroup().addGap(11).addComponent(jLabel6)
														.addPreferredGap(ComponentPlacement.RELATED,
										...
										.addGroup(layout.createParallelGroup(Alignment.TRAILING)
												.addGroup(layout.createSequentialGroup().addGroup(layout
														.createParallelGroup(Alignment.BASELINE).addComponent(jLabel8)
												...
												.addComponent(bankTextField, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
								.addGroup(layout.createSequentialGroup()
										.addComponent(imageLabel, GroupLayout.PREFERRED_SIZE, 238,
												GroupLayout.PREFERRED_SIZE)
										.addGap(36)))
						.addPreferredGap(ComponentPlacement.RELATED)
